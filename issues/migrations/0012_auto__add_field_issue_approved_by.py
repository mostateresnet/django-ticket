...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.approved_by'
        db.add_column('issues_issue', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='issue_approved_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.approved_by'
        db.delete_column('issues_issue', 'approved_by_id')
    ...
    models = {
        ...
        'issues.issue': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'issue_assigned_to'", 'null': 'True', 'to': "orm['auth.User']"}),
