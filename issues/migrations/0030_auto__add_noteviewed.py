...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'issues.note': {
            ...
            'viewers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'through': "orm['issues.NoteViewed']", 'symmetrical': 'False'})
        },
        'issues.noteviewed': {
            'Meta': {'object_name': 'NoteViewed'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_viewed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'note': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issues.Note']"}),
