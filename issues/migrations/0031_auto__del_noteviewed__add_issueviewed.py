...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'NoteViewed'
        db.delete_table('issues_noteviewed')

        # Adding model 'IssueViewed'
        db.create_table('issues_issueviewed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('last_viewed', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal('issues', ['IssueViewed'])


    def backwards(self, orm):
        # Adding model 'NoteViewed'
        db.create_table('issues_noteviewed', (
            ('last_viewed', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Note'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('issues', ['NoteViewed'])

        # Deleting model 'IssueViewed'
        db.delete_table('issues_issueviewed')
    ...
    models = {
        ...
        'issues.issue': {
            ...
            'viewers': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'viewer_set'", 'symmetrical': 'False', 'through': "orm['issues.IssueViewed']", 'to': "orm['auth.User']"})
        },
        'issues.issueviewed': {
            'Meta': {'object_name': 'IssueViewed'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issues.Issue']"}),
            'last_viewed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'issues.milestone': {
            'Meta': {'object_name': 'Milestone'},
            'deadline': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
