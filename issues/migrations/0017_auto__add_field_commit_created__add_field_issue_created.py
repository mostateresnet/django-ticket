...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commit.created'
        db.add_column('issues_commit', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.created'
        db.add_column('issues_issue', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commit.created'
        db.delete_column('issues_commit', 'created')

        # Deleting field 'Issue.created'
        db.delete_column('issues_issue', 'created')
    ...
    models = {
        ...
        'issues.commit': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'now', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
