...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('issues_project', 'scm_type', self.gf('django.db.models.fields.CharField')(max_length='64', null=True))

    def backwards(self, orm):

        # Changing field 'Project.scm_type'
        db.alter_column('issues_project', 'scm_type', self.gf('django.db.models.fields.CharField')(max_length='64'))
