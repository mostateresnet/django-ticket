...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Issue.closed_by_revision'
        db.delete_column('issues_issue', 'closed_by_revision')


    def backwards(self, orm):
        # Adding field 'Issue.closed_by_revision'
        db.add_column('issues_issue', 'closed_by_revision',
