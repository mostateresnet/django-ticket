...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Milestone.due_date'
        db.add_column('issues_milestone', 'due_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Milestone.due_date'
        db.delete_column('issues_milestone', 'due_date')
    ...
    models = {
        ...
        'issues.milestone': {
            ...
            'due_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
